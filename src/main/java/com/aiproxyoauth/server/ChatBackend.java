...
public interface ChatBackend {
    ...
    default boolean supports(com.fasterxml.jackson.databind.JsonNode body, ModelRoute route, boolean responses) throws Exception {
        return !body.hasNonNull("reasoning") && !body.hasNonNull("reasoning_effort")
                && textAndToolsOnly(body.path(responses ? "input" : "messages"));
    }

    private static boolean textAndToolsOnly(com.fasterxml.jackson.databind.JsonNode node) {
